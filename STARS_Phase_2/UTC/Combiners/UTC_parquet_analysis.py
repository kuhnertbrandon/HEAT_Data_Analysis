...
class HEAT_Analysis():
	...
	def pull_daq_channels_live(self):
		...
		if len(daq_headers) == 48:
			...
			user_chan_list = ['200D', '150D', '100D', '50D', '25D', '10D', '200C1', '150C1', '100C1', '50C1', '25C1', '10C1', '200B1', '150B1', '100B1', '50B1', '25B1', '10B1', '200A1', '150A1', '100A1', '50A1', '25A1', '10A1', '10A2', '25A2', '50A2', '100A2', '150A2', '200A2', '10B2', '25B2', '50B1', '100B2', '150B2', '200B2', '10C2', '25C2', '50C2', '100C2', '150C2', '200C2', '200E', '150E', '100E', '50E', '25E', '10E']
		else:
