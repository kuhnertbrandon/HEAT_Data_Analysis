...
def plot_bigdf_moving_average(bigdf,title,dirs):
	...
	ax1.legend(fancybox=True,framealpha=1,fontsize=24)
	...
	ax2.legend(fancybox=True,framealpha=1,fontsize=24)
...
def master_scatter(limit_df,x_ax,y_ax): ## WIP 
	df = scat_df
	x_ax = '> 100 ohms'
	y_ax = 'Strain (%)'
	...
	plt.ylim((0,100))
	plt.savefig('Master_plot_2023_06_15.jpg')

def comparison_bar_plot_Hack(old_df,new_df):
	## Call N-drive
	...
	ax1.set_title('Average of 5 w/ Stiffeners',fontsize=24)
	...
	ax2.set_title('New Data',fontsize=24)
